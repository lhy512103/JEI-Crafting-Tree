...
- Added merged material overview, quantity calculation, and required pattern count display.
...
- 初始 GitHub 发布版本。
- 添加 JEI 配方树总览和递归配方展开。
- 添加合并材料总览、数量演算和所需样板数显示。
- 添加悬浮总材料面板，并支持 JEI 配方和用途快捷跳转。
- 添加可选后端 API，用于接入 AE2 相关的样板提示、编码和上传工作流。
