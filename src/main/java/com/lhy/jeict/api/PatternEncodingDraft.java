...
public final class PatternEncodingDraft {
    ...
    private PatternEncodingDraft(String sourceRecipeIdentity, PatternEncodingMode mode,
        ...
        PatternEncodingSlot primary = this.outputs.isEmpty() ? null : this.outputs.get(0);
    ...
    public void cyclePrimaryOutput() {
        ...
        PatternEncodingSlot first = outputs.remove(0);
        outputs.add(first);
    }
    ...
    public boolean primaryOutputChanged() {
        PatternEncodingSlot primary = outputs.isEmpty() ? null : outputs.get(0);
